  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 sm:py-10 space-y-6 sm:space-y-10">
      <div>
        ...
        <p className="text-muted text-sm mt-1">{t('feat_ai_desc')}</p>
      </div>
      ...
      <div className="bg-card border border-card rounded-xl overflow-hidden">
        ...
        <div className="h-[350px] sm:h-[400px] overflow-y-auto p-4 sm:p-6 space-y-4">
            ...
            <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
              <div className={`max-w-[90%] sm:max-w-[80%] rounded-xl px-4 py-3 text-sm leading-relaxed ${
                msg.role === 'user'
                  ...
                  : 'bg-input border border-input text-fg rounded-bl-sm'
              }`}>
          ...
          {loading && (
            <div className="flex justify-start">
              <div className="max-w-[90%] sm:max-w-[80%] rounded-xl rounded-bl-sm px-4 py-3 bg-input border border-input text-sm text-muted">
        ...
        {/* Input */}
        <div className="border-t border-card p-3 sm:p-4">
          <div className="flex gap-3">
            <input
              ...
              disabled={loading}
              className="flex-1 px-4 py-2.5 rounded-xl bg-input border border-input text-sm text-fg placeholder:text-muted/50 transition-all disabled:opacity-50"
            />
            <button
              onClick={handleSend}
