    ...
    <nav className="fixed top-0 w-full z-50 bg-[#0a0a1a]/90 backdrop-blur-md border-b border-white/5">
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 sm:gap-3 text-sm">
          ...
          <button
            onClick={toggleLang}
            className="ml-1 px-3 py-1.5 rounded-lg border border-white/10 text-xs font-medium text-xiaomi-muted hover:text-white hover:border-xiaomi-orange/50 transition-all cursor-pointer"
          >
            {lang === 'en' ? '中文' : 'EN'}
          </button>
        </div>
